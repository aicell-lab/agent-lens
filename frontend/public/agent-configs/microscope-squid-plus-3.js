...
- Do not add autofocus, imaging, or scans, and other operations that are not explicitly requested by the user, but you can check the status of the microscope before the operation.
