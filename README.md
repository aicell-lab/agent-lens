...
- **Image Capture**: Snap images directly from the microscope with adjustable settings.
...
- **ImJoy-RPC**: Enables remote procedure calls to interact with backend services.
...
- **ImJoy-RPC**: Facilitates communication with backend services.
