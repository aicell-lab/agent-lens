...
# Micro-SAM model is from https://github.com/computational-cell-analytics/micro-sam, the author is  @constantinpape

# This Python script registers a SAM (Segment Anything Model) annotation service on the Agent Lens workspace, 
...
async def register_service(args: dict) -> None:
    ...
    logger.info(
        f"Service (service_id={args.service_id}) started successfully, available at {args.server_url}/agent-lens/services"
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Register SAM annotation service on Agent Lens workspace."
    )
    parser.add_argument(
        "--server_url",
